...
| [SearXNG](searxng/) | ![stable](https://img.shields.io/badge/-stable-2ea44f?style=flat-square) | `searxng/searxng` [![GitHub Release](https://img.shields.io/github/v/release/searxng/searxng?style=flat-square&logo=github&label=)](https://github.com/searxng/searxng/releases) | Search | Privacy-respecting metasearch engine |
...
| [Forgejo](forgejo/) | ![wip](https://img.shields.io/badge/-wip-FFA500?style=flat-square) | `forgejo/forgejo` [![Codeberg Release](https://img.shields.io/gitea/v/release/forgejo/forgejo?gitea_url=https%3A%2F%2Fcodeberg.org&style=flat-square&label=)](https://codeberg.org/forgejo/forgejo/releases) | Git | Self-hosted Git platform — free GitHub alternative with repos, issues, CI/CD and package registry |
